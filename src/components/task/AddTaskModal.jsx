...
const AddTaskModal = ({ onSave,taskToUpdate,handleClose }) => {
  ...
  return (
    <>
      ...
      <form className="absolute top-1/4 left-1/4 z-10 mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11">
